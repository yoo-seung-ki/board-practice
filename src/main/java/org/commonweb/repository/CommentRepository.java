...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    long countByPostId(Long postId); // 특정 게시글에 대한 댓글 수 세기
    ...
    Page<Comment> findCommentsByUserAndDateRange(@Param("userId") Long userId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
}
